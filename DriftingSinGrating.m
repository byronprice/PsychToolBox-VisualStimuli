function [] = DriftingSinGrating(Dist_To_Screen,Display_Time,Parameters)
%DriftingSinGrating.m
%  Display an arbitrary number of drifting sinusoidal gratings on the screen.
...
% Created: 2016/01/26 at 24 Cummington, Boston
%  Byron Price
% Updated: 2016/02/05
%  By: Byron Price
...
if nargin == 0
    ...
    for k=1:nums
        for j=1:nums
            xLeft = ((k-1)/nums)*w_pixels;
            xRight = ((k)/nums)*w_pixels;
