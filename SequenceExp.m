function [] = SequenceExp(Dist_To_Screen,Display_Time,Parameters)
%SequenceExp.m
...
if nargin == 0
    ...
    Parameters(1,:) = [1,0,1,45,.75*w_pixels,0.85*w_pixels,0.75*h_pixels,0.85*h_pixels];
    Parameters(2,:) = [1,0,1,100,0.15*w_pixels,0.25*w_pixels,0.05*h_pixels,0.15*h_pixels];
    Parameters(3,:) = [1,0,1,10,0.4*w_pixels,0.5*w_pixels,0.55*h_pixels,0.65*h_pixels];
    Parameters(4,:) = [1,0,1,165,0.65*w_pixels,0.75*w_pixels,0.35*h_pixels,0.45*h_pixels];
end
